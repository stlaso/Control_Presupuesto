...
function App() {
  ...
  useEffect(() => {
    const presupuestoLS=Number(localStorage.getItem('presupuest') ?? 0)
    if(presupuesto>0)
    {
  ...
  return (
    <div className={modal ? 'fijar' : ''}>
      <Header  setPresupuesto={setPresupuesto} presupuesto={presupuesto} isValidPresupuesto={isValidPresupuesto} setIsValidPresupuesto={setIsValidPresupuesto} gastos={gastos} setGastos={setGastos} />
